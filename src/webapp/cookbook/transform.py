...
"ingredients": a list of dictionaries, with keys "ingredient", mapping to the name of the ingredient, and "amount" which is a string containing the amount of this ingredient needed including the unit, or 
               ...
               and "packet of noodles" should yield {{'amount': '1 packet', 'ingredient': 'noodles'}}. Finally, "¼ cup olive oil" should yield {{'amount': '¼ cup', 'ingredient': 'olive oil'}}.
               If no amount is specified in a separate ingredients section, infer the "amount" from the recipe if it is mentioned there.
